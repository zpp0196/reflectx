...
public class Reflect {
    ...
    public static Reflect on(Object object) {
        if (object instanceof Class<?>) {
            return new Reflect((Class<?>) object);
        }
    ...
    /**
     * @param type 需要包装的类型
     * @return 如果给定的Class是原始类型, 那么将其包装为对象类型, 否则返回本身.
     */
     ...
     * @param name name {@link Field#getName()}
     * @param <T>  the type if field value
     * @return object
     * @throws ReflectException e
     * @author zpp0196
     */
    public <T> T get(Class<?> type, String name) throws ReflectException {
        return field(type, name).get();
    }
     ...
     * @return Reflect with field value
     * @throws ReflectException e
     * @author zpp0196
     */
    public Reflect field(Class<?> type, String name) throws ReflectException {
        try {
            Field field = exactField(type, name);
            return on(field.get(object));
        } catch (Exception e) {
            throw new ReflectException(object.getClass().getName(), e);
        }
     ...
     * @param type  {@link Field#getType()}
     * @param name  {@link Field#getName()}
     * @param value {@link Field#get(Object)}
     * @return this
     * @throws ReflectException e
     * @author zpp0196
     */
    public Reflect set(Class<?> type, String name, Object value) throws ReflectException {
        try {
            Field field = exactField(type, name);
            field.set(object, unwrap(value));
            return this;
     ...
     * @return exact field
     * @throws ReflectException  e
     * @throws NoSuchMethodError if No matching class was found
     * @author zpp0196
     */
    public Field exactField(Class<?> type, String name) throws ReflectException {
        Class<?> clz = type();
        Field field = null;
        try {
        ...
        if (field == null) {
            throw new ReflectException(new NoSuchFieldException(object + "#" + name + ": " + type.getName()));
        }
        field.setAccessible(true);
        return field;
    }
